...
IL_0042:
	{
		GameNotificationChannel_t965853DFEB08011C758BCE9842D4D2D40ADA031E L_5 = ___0_item;
		GameNotificationChannel_t965853DFEB08011C758BCE9842D4D2D40ADA031E L_6 = L_5;
		RuntimeObject* L_7 = Box(il2cpp_rgctx_data_no_init(method->rgctx_data, 1), &L_6);
		Il2CppFakeBox<GameNotificationChannel_t965853DFEB08011C758BCE9842D4D2D40ADA031E> L_8(il2cpp_rgctx_data(method->rgctx_data, 1), (&V_2));
		bool L_9;
		L_9 = ValueType_Equals_mCA5344597A8055EC544855AD60A983B10E0EE67D((ValueType_t6D9B272BD21782F0A9A14F2E41F85A50E97A986F*)(&L_8), L_7, NULL);
		if (!L_9)
		{
